...
<meta name="description" content="365GHS.PRO Mining Pool">
...
function showPageHeader()
{
    ...
    showItemHeader($action == 'api', '/site/api', 'API');
    showItemHeader($action == 'difficulty', '/site/diff', 'Difficulty');
...
function showPageFooter()
{
    ...
    echo "<p>&copy; $year " . YAAMP_SITE_NAME . ' - ' . '<a href="https://powerminers.tech">Stratoshi Corp</a></p>';
